...
For example, if a bank looks like `12345` and you turn on batteries `2` and `4`, the bank would produce `24` jolts. *(You cannot rearrange batteries.)*
...
- In `**8**1111111111111**9**`, you can make the largest joltage possible by turning on `8` and `9`, producing **89** jolts.
- In `2342342342342**78**`, you can make **78** by turning on the last two batteries.
